...
const projectsList = [
    {imgSrc: 'images/weather-project.png',text: '1', hrefLink: '#1'},
    {imgSrc: 'images/dictionary-project.png',text: '2', hrefLink: '#2'},
    {imgSrc: 'images/3.png',text: '3', hrefLink: '#3'},
    {imgSrc: 'images/4.png',text: '4', hrefLink: '#4'}
];
